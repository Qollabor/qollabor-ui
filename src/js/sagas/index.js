...
import { fetchTaskDetails, viewTask, transitionToState, saveTaskDetails } from '../features/task/sagas';
...
const sagas = [
  ...
  [
    takeEvery,
    [
      'LOGIN:DO_LOGIN:FAIL', 'LOGIN:VERIFY:FAIL'
    ],
    unsetLoggedUserFlow
  ],
  [
